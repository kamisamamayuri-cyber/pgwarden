...
SET
  ...
  monthly_retention_enabled = COALESCE(sqlc.narg('monthly_retention_enabled'), monthly_retention_enabled),
  ...
  opt_serializable_deferrable = COALESCE(sqlc.narg('opt_serializable_deferrable'), opt_serializable_deferrable),
  parallel_dump_enabled = COALESCE(sqlc.narg('parallel_dump_enabled'), parallel_dump_enabled),
  parallel_dump_jobs = COALESCE(sqlc.narg('parallel_dump_jobs'), parallel_dump_jobs),
