...
func indexPage(reqCtx reqctx.Ctx, queryData resQueryData) nodx.Node {
	...
	wizardModal := component.Modal(component.ModalParams{
		ID:    wizardModalID,
	...
	newRestoreBtn := nodx.Button(
		nodx.Class("btn btn-primary btn-sm whitespace-nowrap"),
		lucide.Plus(nodx.Class("size-4")),
		nodx.Text("New Restore"),
